...
class osSpop(object):
    ...
    def BlankRow(cls):
            return { 'readonly':'readonly', 'form_visible': 'false',  
                  ...
                  'kd_kecamatan':'', 'kd_dati2':'','kd_propinsi':'', 'kd_kelurahan':'',
                  'kd_blok':'', 'no_urut':'', 'kd_jns_op':'', 'subjek_pajak_id':'',
                  'no_formulir_spop':'', 'no_persil':'', 'jalan_op':'',
                  'blok_kav_no_op':'', 'rw_op':'', 'rt_op':'', 'kd_status_cabang':'',
                  'kd_status_wp':'', 'total_luas_bumi':'', 'total_luas_bng':'',
                  'njop_bumi':'', 'njop_bng':'',  'status_peta_op':'', 'jns_transaksi_op':'',
